...
%% Save the results
Rol_RW=For_result_save(y_h3,y_h6,y_h12,y_h24,y_h36,y_h48,y_h60);
save('.\Results\Rol_RW','Rol_RW');
...
%% Save the results
Rol_Actual=For_result_save(actual_h3,actual_h6,actual_h12,actual_h24,actual_h36,actual_h48,actual_h60);
save('.\Results\Rol_Actual','Rol_Actual');
