%%  DNS_FD_L_u:  lambda is estimated by MLE method
%   Level factor for nonparametric regression, Rolling scheme
...
% MHCV_L_DL=zeros(245,8);
% for i=1:245
%     MHCV_L_DL(i,:)=CV_L_DL(2*i+214,4:11);
% end
...
%% Save the results
Rol_DNS_FD_L_u=For_result_save(y_h3,y_h6,y_h12,y_h24,y_h36,y_h48,y_h60);
save('.\Results\Rol_DNS_FD_L_u','Rol_DNS_FD_L_u');