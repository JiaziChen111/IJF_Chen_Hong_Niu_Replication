%% DNS_FD_spanned: Rolling scheme   lambda is estimated by MLE method
...
for i=1:245
    i
    %Nonparametric regression, Kappa=2, as in other model setup, e.g., DNS_FD_L_u and DNS_FD_LS_u
    YY=[];   zz_86_1952_common=[];

    YY=Y(318+i:557+i,:);  zz_86_1952_common=[z_86_1952(318+i:557+i,2:3);z_86_1952(318+i:557+i,2:3);z_86_1952(318+i:557+i,2:3);...
    z_86_1952(318+i:557+i,2:3);z_86_1952(318+i:557+i,2:3);z_86_1952(318+i:557+i,2:3)];
    YY_common=[]; YY_common=YY(:);
    SP_common_DNS=[];
    SP_common_DNS= fitlm(zz_86_1952_common(:,2),YY_common); % common
    SP_common_DNS_trend=z_86_1952(318+i:557+i,2:3)*SP_common_DNS.Coefficients.Estimate; %240 by 1
    SP_common_DNS_residual=[];
    SP_common_DNS_residual=Y(318+i:557+i,:)-SP_common_DNS_trend*ones(1,6);
...
%% Save the results
Rol_DNS_FD_s=For_result_save(y_h3,y_h6,y_h12,y_h24,y_h36,y_h48,y_h60);
save('.\Results\Rol_DNS_FD_s','Rol_DNS_FD_s');
