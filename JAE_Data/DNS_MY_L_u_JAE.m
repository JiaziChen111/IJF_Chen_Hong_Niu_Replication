...
MY_1985=MY_1952(392:685,:);%1985M1-2009M6
...
for i=1:192
    ...
    % Level factor
    MY_L=[]; MY_L_trend=[];
         MY_L=fitlm(MY_1985(1:102+i,2),Level);
...
% rmsfe_display_DNS_MY_L_h6=[Mat;rmsfe_h6_display]
...
for i=1:192
    ...
    % Level factor
    MY_L=[]; MY_L_trend=[];
         MY_L=fitlm(MY_1985(1:96+i,2),Level);
         MY_L_trend=MY_L.Fitted;
...
rmsfe_h12_display=[rmsfe_3m,rmsfe_6m,rmsfe_9m,rmsfe_12m,...
   ...
   rmsfe_30m,rmsfe_36m,rmsfe_48m, rmsfe_60m, rmsfe_72m,...
   rmsfe_84m,rmsfe_96m, rmsfe_108m, rmsfe_120m];
% rmsfe_display_DNS_MY_L_h12=[Mat;rmsfe_h12_display]
...
for i=1:192
    ...
    % Level factor
    MY_L=[]; MY_L_trend=[];
         MY_L=fitlm(MY_1985(1:84+i,2),Level);
         MY_L_trend=MY_L.Fitted;
...
rmsfe_h24_display=[rmsfe_3m,rmsfe_6m,rmsfe_9m,rmsfe_12m,...
   ...
   rmsfe_30m,rmsfe_36m,rmsfe_48m, rmsfe_60m, rmsfe_72m,...
   rmsfe_84m,rmsfe_96m, rmsfe_108m, rmsfe_120m];
% rmsfe_display_DNS_MY_L_h24=[Mat;rmsfe_h24_display]

%%
Rec_DNS_MY_L_JAE=For_result_save_JAE(y_h6,y_h12,y_h24);
save('.\Results\Rec_DNS_MY_L_JAE','Rec_DNS_MY_L_JAE');
