   ...
   b = b.b';                                % b is length(Mt) by 3 matrix,i.e., 6 by 3
    ...
    SP_L=[]; SP_L_trend=[];
     if MHCV_L_DL(i,8)==1; % Kappa=2
         SP_L=fitlm([z_86_1952(1:557+i,3),esi_history],Level);
         SP_L_trend=SP_L.Fitted;
     elseif MHCV_L_DL(i,8)==2; % Kappa=3
         SP_L=fitlm([z_86_1952(1:557+i,3:4),esi_history],Level);
         SP_L_trend=SP_L.Fitted;
         else MHCV_L_DL(i,8)==3; % Kappa=5
         SP_L=fitlm([z_86_1952(1:557+i,3:6),esi_history],Level);
         SP_L_trend=SP_L.Fitted;   
     end    
...
%% Save the results
Rec_DNS_FD_L_u_RZIG=For_result_save(y_h3,y_h6,y_h12,y_h24,y_h36,y_h48,y_h60);
save('.\Results\Rec_DNS_FD_L_u_RZIG','Rec_DNS_FD_L_u_RZIG');
