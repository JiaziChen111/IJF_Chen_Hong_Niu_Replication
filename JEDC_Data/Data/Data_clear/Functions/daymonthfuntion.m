...
function [monthdata,dates, dates_clear]=dayarrange(daydata)
...
for year=miny:maxy
    for month=1:12
        ...
        maxd=max(datatem(:,4));
        datatem=datatem(datatem(:,4)==maxd,:); % to get end of the month data use maxd. can use min to get the beginning data.
