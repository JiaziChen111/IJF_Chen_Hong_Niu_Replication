%% DNS: Rolling scheme, lambda is estimated by MLE method
% 1st subsample is 1978:M12-1998:M11, last subsample is 1998:M4-2019:M3
...
for i=1:245
   ...
   [bdraw_mle,mu,Phi,Omiga,Phi_Q_mle,B_1_mle,sigma,X_mle,VCV,Y_bar_mle,mu_std,Phi_std] = step_3_Q(Y(318+i:557+i,:)',Mt,bdraw0);
...
%% Save the results
Rol_DNS=For_result_save(y_h3,y_h6,y_h12,y_h24,y_h36,y_h48,y_h60);
save('.\Results\Rol_DNS','Rol_DNS');
