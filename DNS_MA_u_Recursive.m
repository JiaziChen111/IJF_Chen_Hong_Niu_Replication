...
for i=1:245
   ...
   b = b.b';                                % b is length(Mt) by 3 matrix,i.e., 6 by 3
    ...
    factor_all=[Level,Slope,Curvature,data_cpi(1:557+i,1),data_ipg(1:557+i,1)];
...
%% Save the results
Rec_DNS_MA_u=For_result_save(y_h3,y_h6,y_h12,y_h24,y_h36,y_h48,y_h60);
